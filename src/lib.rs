...
//! - PIX strategy (`pix` module, feature `strategy-pix`; the bundled non-anonymous pool needs
//!   `strategy-pix-secp256k1`, while `strategy-pix-curvy` accepts a connector-provided pool)
