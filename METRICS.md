...
| `hopr_strategy_channel_lifecycle_finalizations`              | SimpleCounter | Count of initiated channel closure finalizations                                      |                  |
...
| `hopr_strategy_channel_lifecycle_required_safe_balance_hopr` | SimpleGauge   | wxHOPR the safe must hold to satisfy the demand of the last tick, in base units       | buckets: BUCKETS |
